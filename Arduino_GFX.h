...
public:
  ...
  virtual inline void writePixel(int16_t x, int16_t y, uint16_t color) = 0;
  ...
  virtual void draw16bitRGBBitmap(int16_t x, int16_t y, const uint16_t bitmap[], const uint8_t mask[], int16_t w, int16_t h);
  ...
  */
  ...
  /************************************************************************/
  /*!
    @brief      bulk push color operation
    @param      color  16-bit 5-6-5 Color push to next pixel
