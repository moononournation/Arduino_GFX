...
// 0.96" IPS LCD 80x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, 2 /* rotation */, true /* IPS */, 80 /* width */, 160 /* height */, 26 /* col offset 1 */, 1 /* row offset 1 */, 26 /* col offset 2 */, 1 /* row offset 2 */);
