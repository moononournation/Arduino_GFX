...
Arduino_ST7789::Arduino_ST7789(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset, uint8_t row_offset)
...
{
  _bus->writeCommand(i ? ST7789_INVON : ST7789_INVOFF);
}
