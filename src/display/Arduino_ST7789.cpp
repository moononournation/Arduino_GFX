...
{
  spi_operation_t st7789_init_operations[] = {
      {BEGIN_WRITE, 0},
      ...
      {BEGIN_WRITE, 0},
      {WRITE_COMMAND_8, ST7789_COLMOD}, // 3: Set color mode, 16-bit color
      {WRITE_DATA_8, 0x55},
      ...
      {WRITE_DATA_16, 0x0C0C},
      {WRITE_DATA_16, 0x0033},
      {WRITE_DATA_8, 0x33},
  ...
  _bus->batchOperation(st7789_init_operations, sizeof(st7789_init_operations) / sizeof(st7789_init_operations[0]));
