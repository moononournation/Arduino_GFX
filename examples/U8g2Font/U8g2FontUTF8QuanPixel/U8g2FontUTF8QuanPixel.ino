/*******************************************************************************
 * U8g2 QuanPixel font example
 * This font is generated by U8g2 tools:
 * u8g2/tools/font/bdfconv/bdfconv -v -f 1 -b 1 -m "0-4294967295" quan.bdf -o u8g2_font_quan_h_utf8.h -n u8g2_font_quan_h_utf8
 ******************************************************************************/
...
void setup(void)
{
    ...
    gfx->setFont(u8g2_font_quan_h_utf8);
    gfx->setCursor(0, 14);
